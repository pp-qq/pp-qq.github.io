...
安装参见: [jekyll-mermaid](https://github.com/jasonbellamy/jekyll-mermaid/blob/master/readme.md#jekyll-mermaid).

之后在 Post 中使用姿势如下, 具体参考 [mermaidjs](https://mermaidjs.github.io/):
...
注意这里是使用 `{% raw %}{% mermaid  %}, {% endmermaid %}{% endraw %}` 来声明 mermaid block 的.
